...
# NOTE: Configure deployment/terraform/vars/dev.tfvars with your project ID first
setup-dev-env:
	cd deployment/terraform && terraform init && terraform apply --var-file vars/dev.tfvars --auto-approve
